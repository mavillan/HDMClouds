...
all_results = {"rms":rms_list,
               ...
               "time_gr":time_list1,
               "time_tot":time_list2}   
with open(out_dir+'exp-n_gaussians-orionKL.pickle', 'wb') as handle:
...
with open(out_dir+'exp-n_gaussians-orionMono.pickle', 'wb') as handle:
...
with open(out_dir+'exp-n_gaussians-orionKLCube.pickle', 'wb') as handle:
