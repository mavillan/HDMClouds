...
class HDMClouds():
    ...
    def get_approximation(self):
        w = self.get_params_mapped()
        u = u_eval(w, self.sig, self.xc, self.yc, self.xgrid, self.ygrid)
    ...
    def F(self, params):
        ...
        u = u_eval(w, self.sig, self.xc, self.yc, self.xe, self.ye)
        ...
        fb = self.fb
        u_boundary = u_eval(w, self.sig, self.xc, self.yc, self.xb, self.yb)
