 ...
 * 
 * 
 * cdef gm_eval(double[:] c, double[:] sig, double[:] xc, double[:] yc, double[:] xe, double[:] ye):             # <<<<<<<<<<<<<<
 *     """
 *     Fast Gaussian Mixture Evaluation: No truncation
 */

static PyObject *__pyx_f_8fgm_eval_gm_eval(__Pyx_memviewslice __pyx_v_c, __Pyx_memviewslice __pyx_v_sig, __Pyx_memviewslice __pyx_v_xc, __Pyx_memviewslice __pyx_v_yc, __Pyx_memviewslice __pyx_v_xe, __Pyx_memviewslice __pyx_v_ye) {
  int __pyx_v_m;
  int __pyx_v_n;
  int __pyx_v_i;
  int __pyx_v_j;
 ...
 * 
 * 
 * cdef gm_eval_trunc(double[:] w, double[:] sig, double[:] xc, double[:] yc, double[:] xe,             # <<<<<<<<<<<<<<
 *                  double[:] ye, long[:] neigh_indexes, long[:] neigh_indexes_aux):
 *     """
 */

static PyObject *__pyx_f_8fgm_eval_gm_eval_trunc(__Pyx_memviewslice __pyx_v_w, __Pyx_memviewslice __pyx_v_sig, __Pyx_memviewslice __pyx_v_xc, __Pyx_memviewslice __pyx_v_yc, __Pyx_memviewslice __pyx_v_xe, __Pyx_memviewslice __pyx_v_ye, __Pyx_memviewslice __pyx_v_neigh_indexes, __Pyx_memviewslice __pyx_v_neigh_indexes_aux) {
  int __pyx_v_m;
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_v_sind;
 ...
 * 
 * 
 * cdef gm_eval_trunc_thread(double[:] c, double[:] sig, double[:] xc, double[:] yc, double[:] xe,             # <<<<<<<<<<<<<<
 *                    double[:] ye, long[:] neigh_indexes, long[:] neigh_indexes_aux):
 *     """
 */

static PyObject *__pyx_f_8fgm_eval_gm_eval_trunc_thread(__Pyx_memviewslice __pyx_v_c, __Pyx_memviewslice __pyx_v_sig, __Pyx_memviewslice __pyx_v_xc, __Pyx_memviewslice __pyx_v_yc, __Pyx_memviewslice __pyx_v_xe, __Pyx_memviewslice __pyx_v_ye, __Pyx_memviewslice __pyx_v_neigh_indexes, __Pyx_memviewslice __pyx_v_neigh_indexes_aux) {
  int __pyx_v_m;
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_v_sind;
 ...
 * 
 * 
 * cdef gm_eval_trunc_thread2(double[:] c, double[:] sig, double[:] xc, double[:] yc, double[:] xe,             # <<<<<<<<<<<<<<
 *                     double[:] ye, long[:,:] neigh_indexes):
 *     """
 */

static PyObject *__pyx_f_8fgm_eval_gm_eval_trunc_thread2(__Pyx_memviewslice __pyx_v_c, __Pyx_memviewslice __pyx_v_sig, __Pyx_memviewslice __pyx_v_xc, __Pyx_memviewslice __pyx_v_yc, __Pyx_memviewslice __pyx_v_xe, __Pyx_memviewslice __pyx_v_ye, __Pyx_memviewslice __pyx_v_neigh_indexes) {
  int __pyx_v_m;
  int __pyx_v_n;
  int __pyx_v_i;
  int __pyx_v_j;
